...
export const JUDGE_SYSTEM_PROMPT = [
  'You are a strict, impartial evaluator of code reviews. You compare one review against a',
  'ground-truth list of defects in the given source code. Reply with JSON only — no prose.',
].join('\n');
